  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="Judul"
        className="border border-amber-200 rounded-md px-3 py-2 text-sm bg-white text-amber-900 placeholder-amber-400 focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition-all flex-1 min-w-0 max-w-[120px]"
        required
        style={{ minWidth: 80 }}
      />
      <input
        ...
        placeholder="URL"
        className="border border-amber-200 rounded-md px-3 py-2 text-sm bg-white text-amber-900 placeholder-amber-400 focus:border-amber-400 focus:ring-2 focus:ring-amber-100 transition-all flex-1 min-w-0 max-w-[160px]"
        required
        style={{ minWidth: 100 }}
      />
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 ${
            uploading || isDragging
              ...
              : "bg-amber-200 hover:bg-amber-300 text-amber-800 border border-amber-300 hover:border-amber-400"
          }`}
          tabIndex={-1}
          style={{ minWidth: 60 }}
        >
        ...
        {link.image && (
          <img
            src={link.image}
            alt="preview"
            className="w-8 h-8 object-cover rounded-md border border-amber-200 shadow-sm"
